...
#Region "Connection"
    Public Sub New()
        MyBase.new()
        Try
            Functions.WriteLog("Calling Function conn2()")
            conn2()
            Functions.WriteLog("Complted with success")
    ...
    Public Sub conn2()
        ...
        Dim str As String
        Try
            Functions.WriteLog("Starting function")
            'sconn = System.Convert.ToString(Environment.GetCommandLineArgs().GetValue(1))
            ...
            Functions.WriteLog("Attempting To Connect")
            ocompany.Connect()
            ...
            End If
            Functions.WriteLog("Connected Successfully")
        Catch ex As Exception
